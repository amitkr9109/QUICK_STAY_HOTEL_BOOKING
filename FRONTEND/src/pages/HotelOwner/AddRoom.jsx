  ...
  return (
    <>
      <form onSubmit={onSubmitHandler}>
        ...
        <p className='mt-4 text-gray-800'>Images</p>
        ...
        <button className='bg-primary text-white px-8 py-2 rounded md:mt-8 cursor-pointer active:scale-95' disabled={loading}>
