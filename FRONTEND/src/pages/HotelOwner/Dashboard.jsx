        ...
        <table className='w-full'>
          <thead className='bg-gray-50'>
            <tr>
              ...
              <th className='px-4 py-3 text-gray-800 font-medium text-center'>Total Amout</th>
          ...
          <tbody className='text-sm'>
            {dashboardData?.bookings?.map((item, idx) => (
              <tr key={idx}>
                ...
                <td className='px-4 py-3 text-gray-700 border-t border-gray-300 text-center'>{currency} {item?.totalPrice}</td>
