        ...
        <div className="px-4 py-28 md:pb-35 md:pt-32 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="max-w-6xl mt-8 w-full text-gray-800">
                ...
                {bookings?.map((booking, idx) => (
                    <div key={idx} className="grid grid-cols-1 md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 py-6 first:border-t">
                        <div className="flex flex-col md:flex-row">
                            <img src={booking.room.images[0]} className='md:w-44 rounded shadow object-cover' alt="" />
                        ...
                        <div className="flex flex-col items-start justify-center pt-3">
                            ...
                            {!booking?.isPaid && (
                                <button onClick={() => handlePayment(booking._id)} className='px-4 py-1.5 mt-4 text-sm border border-gray-400 rounded-full hover:bg-gray-50 transition-all cursor-pointer'>
                                    Pay Now
                                </button>
                            )}
                        </div>
